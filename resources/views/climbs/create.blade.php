...
@section('content')
    ...
    <form method='POST' action='/climbs/create'>
        ...
        <div class="form-group">
            ...
            <input type="text" name='title'class="form-control" id="title" value='{{ old('email') }}'>
        </div>
        <div class="form-group">
            <label for="difficulty">Difficulty(e.g. V6, 5.10a, etc. )</label>
            <input type="text" name='difficulty' class="form-control" id="difficulty" value='{{ old('difficulty') }}'>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="location" name='location'class="form-control" id="location" value='{{old('location')}}'>
        </div>
        <div class="form-group">
